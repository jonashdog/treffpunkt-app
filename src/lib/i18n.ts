...
export const translations = {
  de: {
    ...
    // Success Screen
    eventCreatedTitle: 'Event erfolgreich erstellt! 🎉',
    shareWhatsApp: 'Per WhatsApp teilen',
    goToEvent: 'Zur Umfrage →',
    // Admin Edit
    editEventDetails: 'Event bearbeiten',
    manageDates: 'Termine verwalten',
    addDate: 'Termin hinzufügen',
    removeDateWarning: 'Auf diesen Termin haben bereits Personen abgestimmt. Trotzdem entfernen?',
    eventUpdated: 'Änderungen gespeichert ✓',
    dateAdded: 'Termin hinzugefügt ✓',
    dateRemoved: 'Termin entfernt',
    minOneDateRequired: 'Mindestens ein Termin muss bestehen bleiben.',
    // FAQ / Privacy
  ...
  en: {
    ...
    // Success Screen
    eventCreatedTitle: 'Event created successfully! 🎉',
    ...
    addDate: 'Add date',
    removeDateWarning: 'People have already voted on this date. Remove anyway?',
    eventUpdated: 'Changes saved ✓',
    dateAdded: 'Date added ✓',
    dateRemoved: 'Date removed',
    minOneDateRequired: 'At least one date must remain.',
    // FAQ / Privacy
    faqTitle: 'FAQ',
